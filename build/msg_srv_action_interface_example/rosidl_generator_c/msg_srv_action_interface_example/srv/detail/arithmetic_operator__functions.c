  ...
  msg_srv_action_interface_example__srv__ArithmeticOperator_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    msg_srv_action_interface_example__srv__ArithmeticOperator_Request * data =
      (msg_srv_action_interface_example__srv__ArithmeticOperator_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!msg_srv_action_interface_example__srv__ArithmeticOperator_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          msg_srv_action_interface_example__srv__ArithmeticOperator_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  msg_srv_action_interface_example__srv__ArithmeticOperator_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    msg_srv_action_interface_example__srv__ArithmeticOperator_Response * data =
      (msg_srv_action_interface_example__srv__ArithmeticOperator_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!msg_srv_action_interface_example__srv__ArithmeticOperator_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          msg_srv_action_interface_example__srv__ArithmeticOperator_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
