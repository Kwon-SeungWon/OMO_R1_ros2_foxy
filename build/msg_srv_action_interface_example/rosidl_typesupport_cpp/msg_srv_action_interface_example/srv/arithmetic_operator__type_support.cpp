...
static const _ArithmeticOperator_Request_type_support_symbol_names_t _ArithmeticOperator_Request_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, msg_srv_action_interface_example, srv, ArithmeticOperator_Request)),
  }
};
...
static const _ArithmeticOperator_Response_type_support_symbol_names_t _ArithmeticOperator_Response_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, msg_srv_action_interface_example, srv, ArithmeticOperator_Response)),
  }
};
...
static const _ArithmeticOperator_type_support_symbol_names_t _ArithmeticOperator_service_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, msg_srv_action_interface_example, srv, ArithmeticOperator)),
  }
};
