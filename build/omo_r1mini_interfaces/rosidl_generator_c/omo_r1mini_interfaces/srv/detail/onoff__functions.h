...
#ifndef OMO_R1MINI_INTERFACES__SRV__DETAIL__ONOFF__FUNCTIONS_H_
#define OMO_R1MINI_INTERFACES__SRV__DETAIL__ONOFF__FUNCTIONS_H_
 ...
 * calls
 * omo_r1mini_interfaces__srv__Onoff_Request__init().
...
/**
 * It calls
 * omo_r1mini_interfaces__srv__Onoff_Request__fini()
 ...
 * omo_r1mini_interfaces__srv__Onoff_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * omo_r1mini_interfaces__srv__Onoff_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * omo_r1mini_interfaces__srv__Onoff_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_omo_r1mini_interfaces
...
/**
 * It calls
 * omo_r1mini_interfaces__srv__Onoff_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_omo_r1mini_interfaces
...
/**
 * It allocates the memory for the array and calls
 * omo_r1mini_interfaces__srv__Onoff_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_omo_r1mini_interfaces
...
/**
 * It calls
 * omo_r1mini_interfaces__srv__Onoff_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // OMO_R1MINI_INTERFACES__SRV__DETAIL__ONOFF__FUNCTIONS_H_
