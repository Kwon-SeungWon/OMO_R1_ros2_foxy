...
static const _Calg_Request_type_support_symbol_names_t _Calg_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, omo_r1mini_interfaces, srv, Calg_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, omo_r1mini_interfaces, srv, Calg_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, omo_r1mini_interfaces, srv, Calg_Request)),
  }
};
...
get_message_type_support_handle<omo_r1mini_interfaces::srv::Calg_Request>()
{
  return &::omo_r1mini_interfaces::srv::rosidl_typesupport_cpp::Calg_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, omo_r1mini_interfaces, srv, Calg_Request)() {
  return get_message_type_support_handle<omo_r1mini_interfaces::srv::Calg_Request>();
}
...
static const _Calg_Response_type_support_symbol_names_t _Calg_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, omo_r1mini_interfaces, srv, Calg_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, omo_r1mini_interfaces, srv, Calg_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, omo_r1mini_interfaces, srv, Calg_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<omo_r1mini_interfaces::srv::Calg_Response>()
{
  return &::omo_r1mini_interfaces::srv::rosidl_typesupport_cpp::Calg_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, omo_r1mini_interfaces, srv, Calg_Response)() {
  return get_message_type_support_handle<omo_r1mini_interfaces::srv::Calg_Response>();
}
...
static const _Calg_type_support_symbol_names_t _Calg_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, omo_r1mini_interfaces, srv, Calg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, omo_r1mini_interfaces, srv, Calg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, omo_r1mini_interfaces, srv, Calg)),
  }
};
...
get_service_type_support_handle<omo_r1mini_interfaces::srv::Calg>()
{
  return &::omo_r1mini_interfaces::srv::rosidl_typesupport_cpp::Calg_service_type_support_handle;
}
