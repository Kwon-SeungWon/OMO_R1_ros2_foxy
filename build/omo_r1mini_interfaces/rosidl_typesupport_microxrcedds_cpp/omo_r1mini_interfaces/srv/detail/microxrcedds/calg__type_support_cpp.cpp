...
#include "omo_r1mini_interfaces/srv/detail/calg__rosidl_typesupport_microxrcedds_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const omo_r1mini_interfaces::srv::Calg_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<omo_r1mini_interfaces::srv::Calg_Request *>(
    untyped_ros_message);
...
static size_t _Calg_Request__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _Calg_Request__callbacks = {
  ...
  _Calg_Request__get_serialized_size_with_initial_alignment,
...
{
  return &omo_r1mini_interfaces::srv::typesupport_microxrcedds_cpp::_Calg_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, omo_r1mini_interfaces, srv, Calg_Request)() {
  return &omo_r1mini_interfaces::srv::typesupport_microxrcedds_cpp::_Calg_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const omo_r1mini_interfaces::srv::Calg_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<omo_r1mini_interfaces::srv::Calg_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _Calg_Response__get_serialized_size_with_initial_alignment(
  const void * untyped_ros_message, size_t current_alignment)
{
  auto typed_message =
    static_cast<const omo_r1mini_interfaces::srv::Calg_Response *>(
...
static message_type_support_callbacks_t _Calg_Response__callbacks = {
  ...
  _Calg_Response__get_serialized_size_with_initial_alignment,
...
{
  return &omo_r1mini_interfaces::srv::typesupport_microxrcedds_cpp::_Calg_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, omo_r1mini_interfaces, srv, Calg_Response)() {
  return &omo_r1mini_interfaces::srv::typesupport_microxrcedds_cpp::_Calg_Response__handle;
}
...
{
  return &omo_r1mini_interfaces::srv::typesupport_microxrcedds_cpp::_Calg__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, omo_r1mini_interfaces, srv, Calg)() {
  return &omo_r1mini_interfaces::srv::typesupport_microxrcedds_cpp::_Calg__handle;
}
