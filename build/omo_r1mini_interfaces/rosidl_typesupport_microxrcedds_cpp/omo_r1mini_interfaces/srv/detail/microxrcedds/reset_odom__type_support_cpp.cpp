...
#include "omo_r1mini_interfaces/srv/detail/reset_odom__rosidl_typesupport_microxrcedds_cpp.hpp"
...
static size_t _ResetOdom_Request__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _ResetOdom_Request__callbacks = {
  ...
  _ResetOdom_Request__get_serialized_size_with_initial_alignment,
...
{
  return &omo_r1mini_interfaces::srv::typesupport_microxrcedds_cpp::_ResetOdom_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, omo_r1mini_interfaces, srv, ResetOdom_Request)() {
  return &omo_r1mini_interfaces::srv::typesupport_microxrcedds_cpp::_ResetOdom_Request__handle;
}
...
static size_t _ResetOdom_Response__get_serialized_size_with_initial_alignment(
  const void * untyped_ros_message, size_t current_alignment)
{
  auto typed_message =
    static_cast<const omo_r1mini_interfaces::srv::ResetOdom_Response *>(
...
static message_type_support_callbacks_t _ResetOdom_Response__callbacks = {
  ...
  _ResetOdom_Response__get_serialized_size_with_initial_alignment,
...
{
  return &omo_r1mini_interfaces::srv::typesupport_microxrcedds_cpp::_ResetOdom_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, omo_r1mini_interfaces, srv, ResetOdom_Response)() {
  return &omo_r1mini_interfaces::srv::typesupport_microxrcedds_cpp::_ResetOdom_Response__handle;
}
...
{
  return &omo_r1mini_interfaces::srv::typesupport_microxrcedds_cpp::_ResetOdom__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, omo_r1mini_interfaces, srv, ResetOdom)() {
  return &omo_r1mini_interfaces::srv::typesupport_microxrcedds_cpp::_ResetOdom__handle;
}
